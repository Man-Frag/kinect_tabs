...
def parse_args():
    ...
    parser.add_argument("--udp-host", default=UDP_HOST, help="UDP host to send live packets and key events to.")
    parser.add_argument("--udp-port", type=int, default=UDP_PORT, help="UDP port to send live packets and key events to.")
